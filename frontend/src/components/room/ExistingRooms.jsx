...
const ExistingRooms = () => {
    ...
    const handleDelete = async (roomId) => {
        ...
        try {
            ...
            setErrorMessage(`Failed to delete room: ${error.message}`);
        }
                            ...
                            {currentRooms.map((room) => (
                                <tr key={room.id} className="text-center">
                                    ...
                                    <td className="text-center">
                                        <Link to={`/view-room/${room.id}`} className="btn btn-outline-secondary btn-sm me-1" title="View">
                                            <BsEye />
                                        </Link>

                                        <Link to={`/edit-room/${room.id}`} className="btn btn-outline-primary btn-sm me-1" title="Edit">
                                            <AiOutlineEdit />
                                        </Link>
